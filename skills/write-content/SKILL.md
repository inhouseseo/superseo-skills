...
If the `research/content-writing/` library is available in this repo, load the matching template for H1/H2 structure, schema, featured snippet format, CTA placement, word count targets.
